...
extension ContentContainer {
    public func update<D: KeyPathQueryable>(_ instance: D, maxSize: Int = 65_536, using decoder: JSONDecoder = JSONDecoder(), withAllowedKeyPaths keyPaths: [MeowWritableKeyPath]) throws -> Future<[PartialKeyPath<D>]> {
